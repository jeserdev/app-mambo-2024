...
const OrderMainScreenCuts = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(orderRef, (snapshot) => {
      ...
      if (data) {
        let orders = Object.keys(data).flatMap((userKey) => {
          if (data[userKey]) {
      ...
      ListHeaderComponent={
        <>
          <View style={styles.header}>
            <Text style={styles.title}>Pedido General Todos</Text>
          </View>
          ...
          <TouchableOpacity onPress={handleSendOrders}>
            <View style={styles.buttonContainer}>
              <Text style={styles.buttonText}>Cambiar estados de pedidos</Text>
...
export default OrderMainScreenCuts
